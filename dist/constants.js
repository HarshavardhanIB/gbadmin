...
exports.rolloverUnusedWalletFunds = ['PRE_FUNDED_MONTHLY', 'PRE_FUNDED_QUATERLY', 'PAY_AS_YOU_GO'];
exports.walletAllotment = ['FULL_YEAR', 'PRORATED'];
exports.walletType = ['HEATH_SPENDING_ACCOUNT', 'WELLNESS_SPENDING_ACCOUNT', 'BOTH'];
exports.payForService = ['PRE_FUNDED_MONTHLY', 'PRE_FUNDED_QUATERLY', 'PAY_AS_YOU_GO'];
exports.USER_ROLE = {
    CUSTOMER: 'CUSTOMER',
