...
declare const GroupBenfitsAdminPortalApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class GroupBenfitsAdminPortalApplication extends GroupBenfitsAdminPortalApplication_base {
