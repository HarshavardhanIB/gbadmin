...
exports.MailHelperService = void 0;
const tslib_1 = require("tslib");
const core_1 = require("@loopback/core");
const configurations_1 = require("../configurations");
const CONST = tslib_1.__importStar(require("../constants"));
const paths_1 = require("../paths");
let MailHelperService = class MailHelperService {
  ...
  .w25{
    ...
    .mail-regards{
      ...
      font-family: Calibri,sans-serif;
        ...
        this.bottom_line = `<br><br><div class="bottom-line"><img src="${paths_1.GB_LOGO}" alt="GroupBenefitz Logo" />&nbsp;<span></span></div>`;
    }
    //bottom_line = `<br><br><div class="bottom-line"><img src="${GB_LOGO_B64}" alt="GroupBenefitz Logo" />&nbsp;<span></span></div>`
    getPaymentMailBodyGeneric(name, bodyStatement, paymentDetails) {
        let html = this.style +
            `<div class='gb-aitp'>` +
    ...
    getPaymentFailedMailBodyBroker(name, paymentDetails) {
    ...
    getPaymentFailedMailBodyCustomer(name, paymentDetails) {
    ...
    getPaymentSuccessMailBodyBroker(name, paymentDetails) {
    ...
    getPaymentSuccessMailBodyCustomer(name, paymentDetails) {
        let bodyStatement = "Your payment success at GroupBenefitz/Fusebill with following details:";
        return this.getPaymentMailBodyGeneric(name, bodyStatement, paymentDetails);
    }
    getCustomerRegistartionMailBodyGeneric(name, bodyStatement, userdetails) {
        let html = this.style +
            `<div class='gb-aitp'>` +
            `<p>Hi <strong>${name}</strong>,</p>` +
            //`<br>` +
    ...
    getCustomerRegistartionMailBodySysadmin(name, userdetails, brokerDetails) {
    ...
    getCustomerRegistartionMailBodyBroker(name, userdetails) {
        let bodyStatement = "Customer is registered at GroupBenefitz with following details:";
        return this.getCustomerRegistartionMailBodyGeneric(name, bodyStatement, userdetails);
    }
    ...
    getCustomerRegistartionMailBodyCustomer_bck(name, userdetails) {
    ...
    getCustomerRegistartionMailBodyCustomer(name, userdetails) {
    ...
    getGreenshiledRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails) {
        let html = this.style +
            `<div class='gb-aitp'>` +
            `<p>Hi <strong>${name}</strong>,</p>` +
            //`<br>` +
    ...
    getGreenshieldSuccessBody(name, userdetails, brokerDetails, planDetails) {
    ...
    getGreenshieldFailBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getGreenshieldEnrollmentDateIssueBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getGreenshieldSpecialchildBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
            "The customer below has signed up for the following packages effective at {{Enrolment date}}";
        return this.getGreenshiledRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails);
    ...
    getGreenshieldTerminationBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getGreenshieldTerminationFailBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getEquitableRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails) {
        let html = this.style +
            `<div class='gb-aitp'>` +
            // `<p>Hi <strong>${name}</strong>,</p>` +
    ...
    getEquitableSuccessBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getEquitableFailBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getEquitableEnrollmentDateIssueBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getEquitableCustomerHireDateIssueBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
            "The customer below has signed up for the following packages effective at {{Enrolment date}} and this is not acceptable at Equitable";
        return this.getEquitableRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails);
    ...
    getEquitableSpecialchildBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
            "The customer below has signed up for the following packages effective at {{Enrolment date}}";
        return this.getEquitableRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails);
    ...
    getEquitableMinorCustomerBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
            "The customer below has signed up for the following packages effective at {{Enrolment date}}";
        return this.getEquitableRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails);
    ...
    getEquitableMajorStudentChildBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
            "The customer below has signed up for the following packages effective at {{Enrolment date}}";
        return this.getEquitableRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails);
    ...
    getEquitableGenderIssueBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
            "The customer below has signed up for the following packages effective at {{Enrolment date}}";
        return this.getEquitableRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails);
    ...
    getEquitableDivisionClassIssueBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
            "The customer below has signed up for the following packages effective at {{Enrolment date}}";
        return this.getEquitableRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails);
    ...
    getEquitableTerminationBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
            "The customer below has signed up for the following packages effective at {{Enrolment date}}, is terminated";
        return this.getEquitableRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails);
    ...
    getEquitableTerminationFailBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getEquitableHealthcardIssueBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    /********* Reports ************* */
    getCustomerReportsMailBodyGeneric(name, bodyStatement) {
        let html = this.style +
            `<div class='gb-aitp'>` +
            `<p>Hi <strong>${name}</strong>,</p>` +
            //`<br>` +
    ...
    getCustomerReportsMailBodySysadmin(name, body, attachment) {
    ...
    getCustomerReportsMailBodyBroker(name) {
        let bodyStatement = "Customer is registered at GroupBenefitz with following details:";
        return this.getCustomerReportsMailBodyGeneric(name, bodyStatement);
    }
    //Plans check
    getFusebillPlanIssueBodyGeneric(name, bodyStatement, planDetails) {
        let html = this.style +
            `<div class='gb-aitp'>` +
            `<p>Hi <strong>${name}</strong>,</p>` +
            //`<br>` +
    ...
    getFusebillPlanIdIssueBody(name, planDetails) {
    ...
    getFusebillPlanFrequencyIdIssueBody(name, planDetails) {
        let bodyStatement = "Below plan(frequency) has not found at Fusebill";
        return this.getFusebillPlanIssueBodyGeneric(name, bodyStatement, planDetails);
    }
    //brokership transfered
    getBrokershipTransferedBodyGeneric(name, bodyStatement, customerDetails) {
        let html = this.style +
            `<div class='gb-aitp'>` +
            `<p>Hi <strong>${name}</strong>,</p>` +
            //`<br>` +
    ...
    getBrokershipTransferedBody(name, customerDetails) {
    ...
    getExecutiveRegistartionMailBodyGeneric(name, bodyStatement, userdetails, planDetails) {
        let html = this.style +
            `<div class='gb-aitp'>` +
            // `<p>Hi <strong>${name}</strong>,</p>` +
            `<p>Hi <strong>Admin/Broker</strong>,</p>` +
    ...
    getExecutiveSuccessBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getExecutiveFailBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getExecutiveTerminationSuccessBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
    ...
    getExecutiveTerminationFailBody(name, userdetails, brokerDetails, planDetails) {
        let bodyStatement = brokerDetails +
            "<br> " +
...
MailHelperService = tslib_1.__decorate([
    (0, core_1.injectable)({ scope: core_1.BindingScope.TRANSIENT }),
    tslib_1.__metadata("design:paramtypes", [])
], MailHelperService);
exports.MailHelperService = MailHelperService;
//# sourceMappingURL=mail-helper.service.js.map