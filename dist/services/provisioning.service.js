...
const greenshield_provisioning_service_1 = require("./greenshield-provisioning.service");
let ProvisioningService = class ProvisioningService {
    constructor(customerRepository, contactInfoRepository, customerContactInfoRepository, customerPlansRepository, fusebill, 
    // @service(CustomerRegistrationService)
    // public registered: CustomerRegistrationService,
    greenshieldProvisioning, exec) {
        ...
        this.greenshieldProvisioning = greenshieldProvisioning;
        this.exec = exec;
    }
    /*
    ...
    async provisionAll(customers) {
        ...
        console.log(`Customers: ${customers === null || customers === void 0 ? void 0 : customers.length}`);
        console.log(`greenshieldCustomers: ${greenshieldCustomers === null || greenshieldCustomers === void 0 ? void 0 : greenshieldCustomers.length}`);
        const gsCustomersData = await this.greenshieldProvisioning.provisionGreenshield(greenshieldCustomers);
        return gsCustomersData;
    }
    async greenshieldUserRegistartion(customer, greenshieldPlans) {
        let greenshieldPlan;
    ...
    async greenshieldUserTermination(customer) {
        const result = await this.greenshieldProvisioning.terminateGreenshieldSingle(customer);
        return result;
    }
    async executiveUserRegistartion(customer, executivePlansx) {
...
ProvisioningService = tslib_1.__decorate([
    ...
    tslib_1.__param(3, (0, repository_1.repository)(repositories_1.CustomerPlansRepository)),
    tslib_1.__param(4, (0, core_1.service)(fusebill_service_1.FusebillService)),
    tslib_1.__param(5, (0, core_1.service)(greenshield_provisioning_service_1.GreenshieldProvisioningService)),
    tslib_1.__param(6, (0, core_1.service)(candoo_health_provisioning_service_1.CandooHealthProvisioningService)),
    tslib_1.__metadata("design:paramtypes", [repositories_1.CustomerRepository,
        ...
        fusebill_service_1.FusebillService,
        greenshield_provisioning_service_1.GreenshieldProvisioningService,
