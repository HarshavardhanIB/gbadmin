...
exports.GreenshieldPlanLevelMappingRepository = void 0;
const tslib_1 = require("tslib");
const core_1 = require("@loopback/core");
const repository_1 = require("@loopback/repository");
const datasources_1 = require("../datasources");
const models_1 = require("../models");
let GreenshieldPlanLevelMappingRepository = class GreenshieldPlanLevelMappingRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.GreenshieldPlanLevelMapping, dataSource);
    }
};
