...
], Company.prototype, "contactId", void 0);
tslib_1.__decorate([
    (0, repository_1.property)({
        type: 'string',
        length: 45,
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], Company.prototype, "fusebillCustomerId", void 0);
tslib_1.__decorate([
    (0, repository_1.property)({
        type: 'string',
        length: 45,
    ...
    tslib_1.__metadata("design:type", String)
], Company.prototype, "fusebillPaymentId", void 0);
tslib_1.__decorate([
    (0, repository_1.property)({
        type: 'number',
        required: true,
...
Company = tslib_1.__decorate([
    (0, repository_1.model)({ settings: { idInjection: false, mysql: { schema: 'gbadmin', table: 'company' } } }),
