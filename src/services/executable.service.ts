...
import {SERVER_ROE_FOLDER} from '../paths';
...
export class ExecutableService {
  ...
  async generateROE(json: any) {
    ...
    var exefile;
    if (isWin)
      exefile = SERVER_ROE_FOLDER + "/enrollment.exe"
    else
      exefile = SERVER_ROE_FOLDER + "/enrollment"
  ...
  async generateHealthCards(json: any) {
    ...
    var exefile;
    if (isWin)
      exefile = SERVER_ROE_FOLDER + "/healthcards.exe"
    else
      exefile = SERVER_ROE_FOLDER + "/healthcards"
