...
const getLimiter = options => new Bottleneck__default['default']({
  maxConcurrent: 2,
  minTime: 1000 / 9,
  ...options.limiter
});
...
const prepareParams = (opts, self) => {
  const params = ___default['default'].cloneDeep(opts);
...
class Client extends events.EventEmitter {
  constructor(options = {}) {
    ...
    this.on('apiCall', params => {
      debug('apiCall', ___default['default'].pick(params, ['method', 'url']));
      this.apiCalls += 1;
    });
  ...
  apiRequest(opts) {
    ...
    return this.checkApiLimit(params).then(() => {
      ...
      return this.limiter.schedule(() => axios__default['default'](params).then(res => {
